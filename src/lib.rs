...
#[derive(Debug)]
pub struct PrimePulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimePulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimePulse processing");
    
    let mut processor = PrimePulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimePulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimePulseProcessor::new(false);
